...
```{r}
#Recode dm to no=0 yes=1
db$dm <- recode(db$dm, "no" = 0, "yes" = 1)
...
# calculate the odds
odds_dm_gender <- dm_gender_prop[,"1"]/dm_gender_prop[,"0"]
...
# calculate the odds
odds_age <- dm_by_age_prop[,"1"]/dm_by_age_prop[,"0"]
...
# calculate the odds
odds_age_group <- dm_by_agegroup_prop[,"1"]/dm_by_agegroup_prop[,"0"]
...
# calculate the odds
odds_chol <- dm_by_chol_prop[,"1"]/dm_by_chol_prop[,"0"]
...
odds_cholcat <- dm_by_cholcat_prop[,"1"]/ dm_by_cholcat_prop[,"0"]
...
# calculate the odds
odds_hdl <- dm_by_hdl_prop[,"1"]/dm_by_hdl_prop[,"0"]
...
odds_hdlcat <- db_by_hdlcat_prop[,"1"]/db_by_hdlcat_prop[,"0"]
...
dm_by_bmi_odds <- dm_by_bmi_prop[,"1"]/dm_by_bmi_prop[,"0"]
...
odds_dm_by_bmi_cat <- dm_by_bmi_cat_prop[,"1"]/dm_by_bmi_cat_prop[,"0"]
...
According to H-L test, the model does not have good calibration as p-value < 0.05
